...
account_sid = st.secrets("Your acc sid")
...
sendgrid_api = st.secrets("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")
from_email = st.secrets("Your sender's mail ID")
